  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">รับเข้า - หนังสือ</li>
    ...
    <section class="content">
      <div class="card card-secondary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="sql/grn.php" method="post">
          <div class="card-body">
          ...
          <div class="row">
              <div class="col-12 col-sm-4 col-md-2 col-lg-2 p-2">
                <label for="total_qty">รับเข้า</label>
              </div>
              <div class="col-12 col-sm-8 col-md-10 col-lg-10 p-2">
              <input type="number" class="form-control" id="grn" name="grn" placeholder="รับเข้า" required>
              </div>
          </div>
